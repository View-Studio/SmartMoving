...
```
항목 #3 — 상태 전환 조건 이상 진행 중 (세션 2 — B-1 검증 완료, B-19 이미 이식됨 ✓)
```
...
| 4 | **#3** | 상태 전환 조건 이상 | [focus_03](focus_03_transition_conditions.md) | 🟢 진행 중 (P/A/B-1 7/13 = 54%, 잔존 4건 — B-10d/§18.1/B-fromSwim/B-context) | #2 / #2.5 / #2.6 / #2.7 완료 |
